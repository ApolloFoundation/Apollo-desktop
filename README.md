...
Maven wrapper downloads Apache Maven and then builds package. Final package is zip file in "___target___" directory, e.g. ___apollo-desktop-"1.48.9"-NoOS-NoArch.zip___ that contains all required components and libraries.
